...
//
// import 'package:clear_sky/bloc/navigation_bloc/bottom_navigation_bloc.dart';
...
//     return Scaffold(
//       resizeToAvoidBottomInset: false, // to prevent the screen from moving up with the keyboard
//       body: Stack(
//         children: [
...
//       body: Stack(
//         children: [
//           Center(child: Text("Popular Page Content")),
//           Positioned(
//             top: 57,
//             left: 15,
//             right: 15,
...
//                     context.read<BottomNavigationBloc>().add(NavigateToHomeEvent());
...
//                         context.read<BottomNavigationBloc>().add(NavigateToHomeEvent());
//                       } else if (index == 1) {
//                         context.read<BottomNavigationBloc>().add(NavigateToPopularEvent());
//                       }
//                     },
//                     tabs: [
//                       GButton(
